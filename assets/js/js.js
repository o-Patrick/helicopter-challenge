function pressStart(){
	const START_BTT = document.querySelector("#startButton");
...
function start(){
	...
	function gameOver() {
		...
		$("#fim").html("<h1> Game Over </h1><p id='finalScore'>Sua pontuação foi: " + pontos + "</p>" + "<div id='reinicia' onClick=reiniciaJogo()><h3 id='restartButton'>Jogar Novamente</h3></div>");
